...
def create_permission(apps, schema_editor):
    ...
    opts = LogEntry._meta
    codename = "{}_{}".format("truncate", opts.object_name.lower())
    params = {"codename": codename, "content_type": ct, "defaults": {"name": "Can truncate logs"}}
...
def remove_permission(apps, schema_editor):
    ...
    opts = LogEntry._meta
    codename = "{}_{}".format("truncate", opts.object_name.lower())
    params = {"codename": codename, "content_type": ct}
